...
def _run_stage(stage, run_root: Path, extra_args, progress_path: Path, progress: dict, stop_at_loss: float = 0.05, min_improvement: float = 0.01, anchor_text: str = ""):
