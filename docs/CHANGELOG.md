...
- **LiveBench integration** — ORI scores against LiveBench via `gen_api_answer.py --model oricli-bench`. ARC-AGI baseline established (6%, on par with GPT-4); full LiveBench run in progress.
