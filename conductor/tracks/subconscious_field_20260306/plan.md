...
- [ ] Implement `mavaia_core/brain/modules/subconscious_field.py`.
...
- [ ] Update `mavaia_core/brain/modules/cognitive_generator.py` to query the `subconscious_field` during intent detection.
...
- [ ] Teach Mavaia a unique fact via JIT.
