...
- [ ] Implement `mavaia_core/brain/modules/sensory_router.py`.
...
- [ ] Update `mavaia_core/brain/modules/cognitive_generator.py` to support `vision_context` and `audio_context`.
...
- [ ] Verify Mavaia acknowledges the image and includes its context in her reasoning.
