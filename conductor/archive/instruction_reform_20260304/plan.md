...
- [x] Task: Create `oricli_core/brain/modules/instruction_following.py` with intent detection and raw execution logic.
...
- [x] Task: Update `oricli_core/brain/modules/oricli_system_prompt_builder.py` to include `TASK_EXECUTION` mode.
...
- [x] Task: Modify `oricli_core/brain/modules/cognitive_generator.py` to implement the "Hard Bypass" for detected tasks.
