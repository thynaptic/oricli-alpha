...
// running, how long the current session has been active, and how many messages
// have been exchanged. This block is injected into every system prompt so the
// model can reason about elapsed time, session duration, and recency.
