...
func (c *Client) readPump() {
	...
	for {
		...
		// Currently we don't handle incoming messages from the UI via WebSocket, 
		// but the loop is here for future command injection.
	}
}
...
func (s *ServerV2) handleWS(c *gin.Context) {
