import unittest
from mavaia_core.brain.modules.mavaia_system_prompt_builder import MavaiaSystemPromptBuilderModule

class TestMavaiaSystemPromptBuilder(unittest.TestCase):
    def setUp(self):
        self.module = MavaiaSystemPromptBuilderModule()
        self.module.initialize()

    def test_standard_prompt(self):
        # Test building standard prompt
        params = {
            "personality_id": "Mavaia",
        ...
        self.assertIn("PERSONALITY: Mavaia", prompt)
    ...
    def test_task_execution_prompt(self):
        ...
        self.assertNotIn("PERSONALITY: Mavaia", prompt)
