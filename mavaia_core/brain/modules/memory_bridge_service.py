...
Brain-module wrapper around `mavaia_core.services.memory_bridge_service.MemoryBridgeService`.
...
class MemoryBridgeServiceModule(BaseBrainModule):
    """Brain-module wrapper for the MemoryBridgeService (memory.mavaia)."""
    ...
    def metadata(self) -> ModuleMetadata:
        return ModuleMetadata(
            ...
            version="1.0.0",
            description="Encrypted LMDB-backed memory store shared across runtimes (memory.mavaia)",
            operations=[
                "health_check",
                "put",
                "get",
