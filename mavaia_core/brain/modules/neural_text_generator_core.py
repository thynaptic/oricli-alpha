...
class NeuralTextGeneratorCoreModule(BaseBrainModule):
    ...
    def metadata(self) -> ModuleMetadata:
        ...
        return ModuleMetadata(
            ...
            operations=["generate_text", "generate_with_character_model", "generate_with_word_model", "generate_with_transformer"],
            dependencies=[],
    ...
    def execute(self, operation: str, params: Dict[str, Any]) -> Dict[str, Any]:
        """Execute a generation operation"""
        try:
    ...
    # Generation methods will be extracted here
