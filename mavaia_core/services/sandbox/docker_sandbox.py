...
from mavaia_core.services.sandbox.base import SandboxService, SandboxExecutionError
from mavaia_core.services.sandbox.resource_limits import ResourceLimits, ResourceUsage
    ...
    def create_session(
        ...
        try:
            ...
            container = self.docker_client.containers.create(
                ...
                name=f"mavaia-sandbox-{session_id}",
