...
class ChatCompletionRequest(BaseModel):
    ...
    model: str = Field(default="mavaia-cognitive", description="Model identifier")
...
class EmbeddingRequest(BaseModel):
    ...
    model: str = Field(default="mavaia-embeddings", description="Embedding model identifier")
    user: Optional[str] = Field(default=None, description="User identifier")
...
class ModelInfo(BaseModel):
    ...
    created: int = Field(..., description="Unix timestamp")
    owned_by: str = Field(default="mavaia", description="Owner")
