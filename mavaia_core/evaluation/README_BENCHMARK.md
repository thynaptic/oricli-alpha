...
Comprehensive Python coding benchmark for evaluating Mavaia's code generation capabilities against industry standards.

## Overview

This benchmark suite tests Mavaia's Python code generation, completion, and reasoning capabilities across 50 diverse problems covering:
...
```bash
python -m mavaia_core.evaluation.test_runner --module reasoning_code_generator
```
...
python -m mavaia_core.evaluation.test_runner --module reasoning_code_generator --tags easy

# Run only hard problems
python -m mavaia_core.evaluation.test_runner --module reasoning_code_generator --tags hard

# Run specific categories
python -m mavaia_core.evaluation.test_runner --module reasoning_code_generator --tags algorithms
```
...
python -m mavaia_core.evaluation.test_runner --module reasoning_code_generator > results.json

# Generate comparison report
python -m mavaia_core.evaluation.benchmark_comparison results.json benchmark_report.txt
```
...
1. **Code Generation**: Mavaia generates Python code from requirements
...
The benchmark compares Mavaia's performance against:
