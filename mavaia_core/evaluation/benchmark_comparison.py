...
Compares Mavaia's performance against reference benchmarks (HumanEval, MBPP, APPS).
"""
...
class BenchmarkComparison:
    ...
    def compare_with_references(self, benchmark_name: str = "HumanEval") -> Dict[str, Any]:
        ...
        comparison = {
            ...
            "mavaia_pass_rate": self.metrics.pass_rate,
        ...
        for model, score in reference_scores.items():
            ...
            comparison["comparison"][model] = {
                ...
                "mavaia_score": self.metrics.pass_rate,
                "difference": diff,
    ...
    def generate_report(self, output_file: Optional[Path] = None) -> str:
        ...
        for benchmark_name in ["HumanEval", "MBPP", "APPS"]:
            ...
            if "error" not in comparison:
                ...
                report_lines.append(f"  Mavaia Pass Rate: {self.metrics.pass_rate*100:.2f}%")
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m mavaia_core.evaluation.benchmark_comparison <results_file> [output_file]")
        sys.exit(1)
