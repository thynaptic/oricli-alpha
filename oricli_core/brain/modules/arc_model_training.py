...
from oricli_core.brain.modules.arc_synthetic_data import ARCSyntheticDataGenerator
...
class ARCModelTraining:
    ...
    def fine_tune_on_task(
        ...
        Returns:
            Fine-tuned model
        """
        from oricli_core.brain.modules.arc_test_time_training import ARCTestTimeTraining
