...
class ModuleHealthDiagnosticsModule(BaseBrainModule):
    ...
    def _scan_modules(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # after the scan.
        shims: dict[str, str] = {
            "base_module": "oricli_core.brain.base_module",
            "cot_models": "oricli_core.brain.modules.cot_models",
            "tot_models": "oricli_core.brain.modules.tot_models",
            "mcts_models": "oricli_core.brain.modules.mcts_models",
            "tool_calling_models": "oricli_core.brain.modules.tool_calling_models",
            # Many legacy modules used a shim module_registry in modules/; keep that mapping.
            "module_registry": "oricli_core.brain.modules.module_registry",
        }
