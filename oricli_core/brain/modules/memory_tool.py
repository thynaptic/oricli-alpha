...
from oricli_core.exceptions import ModuleOperationError, InvalidParameterError
...
def _lazy_import_storage():
    ...
    if DatabaseStorage is None:
        try:
            from oricli_core.brain.state_storage.db_storage import DatabaseStorage as DS
            from oricli_core.brain.state_storage.base_storage import StorageConfig as SC
            DatabaseStorage = DS
            StorageConfig = SC
