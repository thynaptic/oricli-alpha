...
class OricliAlphaSystemPromptBuilderModule(BaseBrainModule):
    ...
    def __init__(self):
        super().__init__()
        self.versions_file_name = "oricli_standalone_prompt_versions"
        self.versions: Optional[Dict[str, Any]] = None
        self.current_version_id = "oricli-54c"  # 54 cognitive modules, 0 LLMs
    ...
    def _ensure_modules_loaded(self):
        ...
        try:
            ...
            logger.debug(
                ...
                exc_info=True,
                extra={"module_name": "oricli_system_prompt_builder", "error_type": type(e).__name__},
            )
    ...
    def execute(self, operation: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if operation == "build_system_prompt":
            ...
            raise InvalidParameterError(
                parameter="operation",
                value=operation,
                reason="Unknown operation for oricli_system_prompt_builder",
            )
