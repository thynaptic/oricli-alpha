...
def _lazy_import_world_knowledge_deps():
    ...
    if not EMBEDDINGS_AVAILABLE:
        try:
            from oricli_core.brain.modules.embeddings import EmbeddingsModule as EM
            from oricli_core.brain.modules.concept_embeddings import ConceptEmbeddingsModule as CEM
            EmbeddingsModule = EM
