...
def _lazy_import_tools():
    ...
    if Tool is None:
        try:
            from oricli_core.brain.modules.tool_calling_models import (
                Tool as T,
                ToolFunction as TF,
            ...
            from oricli_core.brain.modules.tool_registry import tool_registry as tr
            from oricli_core.brain.modules.tool_schema_generator import (
