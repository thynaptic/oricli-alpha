...
from oricli_core.brain.modules.module_registry import ModuleRegistry
...
def get_system_identifier() -> str:
    ...
    Returns:
        System identifier string (e.g., "oricli-137c")
    """
    ...
    # Construct identifier: oricli-{count}c
    return f"oricli-{module_count}c"
...
def get_system_identifier_with_subname(subname: str) -> str:
    ...
    Format: oricli-{module_count}c-{subname}
    Examples: "oricli-137c-alpha", "oricli-137c-Pro", "oricli-137c-Flash"
    
    Args:
        subname: Sub-name qualifier (e.g., "alpha", "Pro", "Flash")
    
    Returns:
        System identifier string with subname (e.g., "oricli-137c-alpha")
...
MODEL_COGNITIVE: str = "oricli-cognitive"
MODEL_EMBEDDINGS: str = "oricli-embeddings"
