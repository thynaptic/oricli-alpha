...
MMLU-style test suite for comprehensive evaluation of all Oricli-Alpha brain modules and system components.
...
```bash
python -m oricli_core.evaluation.test_runner --report-only results/20250115_103000/detailed_results.json
```
