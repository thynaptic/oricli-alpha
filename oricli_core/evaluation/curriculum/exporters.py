...
from oricli_core.evaluation.curriculum.models import TestResult
...
class CurriculumExporter:
    ...
    def export_to_openai_evals(
        ...
        """
        eval_data = {
            "eval_name": "oricli_curriculum_test",
            "eval_spec": {
                "framework": "oricli_curriculum",
            },
            "results": [],
            "summary": {},
        }
    ...
    def export_to_huggingface(
        ...
        hf_data = {
            "experiment_info": {
                "model_name": "oricli-cognitive",
                "task": "curriculum_evaluation",
                "dataset": "oricli_curriculum",
            },
            "results": {},
            "samples": [],
        }
