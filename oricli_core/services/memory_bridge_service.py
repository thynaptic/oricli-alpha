...
"""
MemoryBridgeService (memory.oricli)
...
class MemoryBridgeConfig:
    ...
    def from_env(cls) -> "MemoryBridgeConfig":
        ...
        - MAVAIA_MEMORY_LMDB_PATH (default: ./.oricli/memory.lmdb)
        ...
        """
        path_str = os.getenv("MAVAIA_MEMORY_LMDB_PATH", str(Path(".oricli") / "memory.lmdb"))
